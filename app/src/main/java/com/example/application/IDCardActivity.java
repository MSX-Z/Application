...
public class IDCardActivity extends AppCompatActivity {
    ...
    /////////*    check intent box ว่ามามี intent box "RMA" ไหม แล้ว hashMap ที่ได้จะเป็นข้อมูลของฝั่ง maid *///////////
        if(getIntent.hasExtra("RMA"))
            hashMap = (HashMap<String,Object>)(getIntent.getSerializableExtra("RMA"));
        else {
            Intent i = new Intent(IDCardActivity.this, LoginActivity.class);
    ...
    private void setAndAddImage(byte[] final_image) {
        ...
        hashMap.put("IdCard_Uri",final_image);

        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(IDCardActivity.this,ProfileActivity.class);
                intent.putExtra("ICA",hashMap);
...
/* Comments 1/10/2020 19:00 Check:True
    ...
    - เมื่อ Compressor จะได้รูปออกมา แล้วนำไป set image กับ put ลงไปใน hashMap แล้วส่งไปยัง ProfileActivity ด้วย Intent box "ICA"
*/